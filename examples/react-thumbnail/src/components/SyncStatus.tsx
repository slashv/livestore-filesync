...
export const SyncStatus: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const unsubscribe = onFileSyncEvent((event) => {
      if (event.type === "upload:progress" || event.type === "download:progress") {
        ...
        setActiveTransfers((prev) => updateActiveTransfers(prev, progress))
      } else if (
        ...
        setActiveTransfers((prev) => removeActiveTransfer(prev, event.fileId))
      }
    })
  ...
  const totalProgress = computeTotalProgress(activeTransfers)
  const activeTransfersList = Object.values(activeTransfers)
        ...
        <>
          ...
          <div data-testid="transfer-progress-section">
            ...
            {activeTransfersList.map((transfer) => (
              <div key={transfer.fileId} className="transfer-item" data-testid="transfer-progress-item">
