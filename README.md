...
- **Batched scan state commits**: Startup/poll scans commit changed thumbnail state updates in one transaction before enqueueing generation work, reducing sync-queue pressure during large cold starts without re-emitting unchanged state
